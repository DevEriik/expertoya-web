      ...
      <div className="bg-white rounded-[2rem] shadow-[0_4px_40px_-10px_rgba(0,0,0,0.03)] border border-gray-100 flex flex-col items-center text-center px-4 py-16 md:py-24 w-full">
        ...
        <div className="w-full max-w-2xl flex flex-col md:flex-row items-center gap-2 bg-white p-2 rounded-2xl shadow-sm border border-gray-100">
          <div className="flex-1 flex items-center w-full px-2">
            ...
            <div className="flex items-center gap-3 text-dark/40 px-3 shrink-0">
              <Mic
                size={20}
          ...
          <button className="w-full md:w-auto shrink-0 px-8 py-4 bg-secondary hover:opacity-90 transition-opacity text-white font-bold rounded-xl flex items-center justify-center gap-2 text-lg">
            <Sparkles size={20} />
